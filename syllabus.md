...
Supplementary readings will be made available on the course homepage, and primarily come from _Learning Data Science_, an online textbook freely available at [learningds.org](https://learningds.org). Some readings will come from [notes.dsc80.com](https://notes.dsc80.com), a set of notes that were originally written to supplement the UCSD version of this class. Supplementary readings are not required, in that you won't be tested on anything that appears only in the readings but not in lectures or assignments, but you should still complete them to supplement your understanding!
...
**Thursdays at 11:59PM**, though this schedule is subject to change. You will access homeworks by pulling the course GitHub repository, and will submit your completed homeworks as Jupyter Notebooks to Gradescope (we will not be using the EECS autograder). You may turn them in as many times as you like before
